...
const App = () => { 
    return <div>
        ...
        <Greetings/>
        <Children>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nam recusandae exercitationem molestias, rerum ducimus consequuntur cumque sunt, labore nisi doloribus beatae voluptate reprehenderit, est minima tempora tempore itaque impedit officia.
            Aut, omnis. Adipisci ipsa harum nesciunt explicabo animi quam error illo accusamus in placeat deleniti nihil maxime ut dolore, iure aperiam quis ullam. Mollitia ipsa, architecto dolorum quasi molestiae facere.
        </Children>
        <DigitalClockAppV2 color="teal" backgroundColor= "yellowgreen" />
        ...
        src="profile.jpg"
        name="Jane"
        location="Shenley Brook End, Milton Keynes"
        statistics= {
            [
                {
                    stat:7,
        ...
        <BootstrapComponents/>
        <BootstrapButtons variant={"outline-warning"} disabled/>
        <ReactIcons/>
        <MaterialIcons/>
        <Events/>
        <ProductShop/>
